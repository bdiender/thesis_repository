...
with open('../../results/all_hans_predictions.txt', 'r') as f:
...
with open('../../results/roberta_hans_eor.csv', 'w') as f:
    f.write(output)
...
for category, kappa_score in fleiss_kappa_scores.items():
    ...
    print(f'RoBERTa;{heuristic};{consistent};{round(kappa_score, 3)}')
